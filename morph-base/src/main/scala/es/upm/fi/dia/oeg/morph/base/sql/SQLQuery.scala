...
class SQLQuery extends ZQuery with IQuery {
  ...
  def this(zQuery:ZQuery ) = {
    ...
    def this(zQuery:ZQuery, skylineClause:String) = {
    this();
    ...
    if (skylineClause.length() > 0)
      this.addSkyline(skylineClause)
  }
