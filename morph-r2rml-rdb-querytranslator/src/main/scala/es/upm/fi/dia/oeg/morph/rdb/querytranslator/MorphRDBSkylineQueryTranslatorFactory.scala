...
class MorphRDBSkylineQueryTranslatorFactory extends MorphRDBQueryTranslatorFactory{

override def createQueryTranslator(abstractMappingDocument:MorphBaseMappingDocument
		...
		val queryTranslator = new MorphRDBSkylineQueryTranslator(nameGenerator
